import { Platform, ActionSheetIOS, Alert, Animated, Easing } from 'react-native';
...
export default function AddInteractionScreen() {
  ...
  const theme = {
    ...
    cardBackground: isDark ? '#1A1A1A' : '#004A2F',
  };
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        ...
        >
          ...
          {showSuggestions && (
            <Animated.View style={{ opacity: suggestionsOpacity, marginBottom: 24 }}>
              <View style={styles.suggestionsContainer}>
                {[
                  'Add Sarah to my Roster list',
                  'Create a reminder for tomorrow at 12p for me to call John',
                  'Schedule a text to Mom for her birthday'
                ].map((text, index) => (
                  <TouchableOpacity
                    key={index}
