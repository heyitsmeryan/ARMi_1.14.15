...
import { ArrowLeft, User, Mail, LogOut, X, Shield, CircleCheck as CheckCircle, CircleAlert as AlertCircle } from 'lucide-react-native';
...
export default function ProfileSettings() {
  ...
  const handleDeleteAccount = () => {
    Alert.alert(
      'Delete Account',
      'Are you sure you want to delete your account? Your account will be deactivated immediately and permanently deleted after 30 days.',
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Delete Account',
